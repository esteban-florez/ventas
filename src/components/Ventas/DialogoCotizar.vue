	...
	<form action="">
		<div class="modal-card" style="width: 600px">
			<header class="modal-card-head has-background-warning">
				...
				<button type="button" class="delete" @click="$emit('close', 'cotiza')" />
			</header>
			...
			<footer class="modal-card-foot">
				<b-button label="Cancelar" icon-left="cancel" size="is-medium" @click="$emit('close', 'cotiza')" />
				<b-button label="Guardar cotización" type="is-dark" icon-left="ticket-outline" size="is-medium"
