    ...
    <div class="columns is-desktop">
      <div class="column">
        <div class="box">
          ...
          <b-table :data="productosMayoresVentas">
            ...
            <b-table-column field="progreso" label="Progreso" v-slot="props">
              <b-progress :type="generarColorPorcentaje(props.row.total)"
                :value="calcularPorcentajeProducto(props.row.total)" show-value></b-progress>
            </b-table-column>
          </b-table>
        </div>
      </div>
